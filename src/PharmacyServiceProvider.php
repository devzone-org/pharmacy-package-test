...
class PharmacyServiceProvider extends ServiceProvider
{
    ...
    private function registerLivewireComponent()
    {
        ...
        Livewire::component('sales.open-returns', \Devzone\Pharmacy\Http\Livewire\Sales\OpenReturns::class);
        Livewire::component('sales.open-returns-add', \Devzone\Pharmacy\Http\Livewire\Sales\OpenReturnsAdd::class);
        ...
        Livewire::component('report.sale-manufacture-wise',\Devzone\Pharmacy\Http\Livewire\Reports\SaleManufactureWise::class);
        Livewire::component('report.product-details',\Devzone\Pharmacy\Http\Livewire\Reports\ProductDetails::class);
