<div class="bg-white pt-6 mt-2 shadow sm:rounded-md sm:overflow-hidden">
    ...
    <div class="p-10 " id="sale_trends"></div>


    <script>
        let labelss = ("{{ json_encode($labels) }}");
        labelss = JSON.parse(labelss.replace(/&quot;/g, '"'));
        ...
        var charthr = new ApexCharts(document.querySelector("#sale_trends"), options);
        charthr.render();
