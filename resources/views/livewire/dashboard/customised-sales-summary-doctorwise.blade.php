<div class="bg-white pt-6 mt-2 shadow sm:rounded-md sm:overflow-hidden">
    ...
    <div class="p-10 " id="chartdoc"></div>
    ...
    <script>
        ...
        var chartsd = new ApexCharts(document.querySelector("#chartdoc"), options);
        chartsd.render();

        window.addEventListener('doctor-wise-sale', event => {
