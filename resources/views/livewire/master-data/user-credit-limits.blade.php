    ...
    <form wire:submit.prevent="create">
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">User Credit Limits</h3>
                </div>
                ...
                <div class="grid grid-cols-6 gap-6">
                    @foreach($users as $key=>$u)
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input wire:model.defer="users.{{$key}}.name" disabled type="text" autocomplete="off"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="name" class="block text-sm font-medium text-gray-700">Credit Limit</label>
                            <input wire:model.defer="users.{{$key}}.credit_limit" type="text" autocomplete="off"
