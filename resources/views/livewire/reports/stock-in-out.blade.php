        ...
        <div class="bg-white py-6 px-4 space-y-6 sm:p-6 ">
            <div class="grid grid-cols-10 gap-6">
                ...
                <div class="col-span-8 sm:col-span-2">
                    ...
                    @if(!empty($report))
                        <a href="{{'stock-in-out/export'}}?product_id={{$product_id}}&manufacture_id={{$manufacture_id}}&rack_id={{$rack_id}}&category_id={{$category_id}}&zero_stock={{$zero_stock}}&from={{$from}}&to={{$to}}" target="_blank"
