<div>
  ...
  Not Approved
        ...
        <table class="min-w-full divide-y divide-gray-200 rounded-md ">
            ...
            <tr>
                <th scope="col" colspan="10" class="w-10 px-3 py-3 text-left text-sm font-medium text-gray-500   ">
            ...
            @foreach($purchase_orders as $key => $m)
                <tr>
                    ...
                    <td colspan="2" class="px-3 py-3   text-sm font-medium text-gray-500">
            ...
            <tr class="bg-gray-50">
                ...
                <th scope="col" colspan="8" class="px-3 py-3 text-left text-sm font-medium text-gray-500   ">
                    Description
                </th>
            ...
            <tr>
                <th scope="col" colspan="9" class="px-3 py-3 text-right text-sm font-medium text-gray-500   ">
                    Selected Orders
                </th>
            ...
            <tr>
                ...
                <th scope="col" class=" px-3 py-3 border text-left text-sm font-medium text-gray-500   ">
                    @php
                        $total_payable_amount = collect($purchase_orders)->whereIn('id',$selected_orders)->sum('total_cost') + collect($purchase_orders)->whereIn('id',$selected_orders)->sum('tax_amount')
            ...
            <tr>
                ...
                <th scope="col" class=" px-3 py-3 border text-left text-sm font-medium text-gray-500   ">
                    {{ \Devzone\Ams\Helper\GeneralJournal::numberFormat(-$total_payable_amount + collect($returns)->whereIn('id',$selected_returns)->sum('total'),2) }}
                </th>
